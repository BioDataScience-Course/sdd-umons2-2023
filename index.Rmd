...
-   [Plan du cours de Science des données biologiques II : années 2023-2024](https://github.com/BioDataScience-Course/BioDataScience-Common/tree/2023-2024/docs/plan_de_cours/sdd2_plan_cours_2023-2024.md)
...
## Déroulement du cours {.unnumbered}

Le cours est divisé en 10 modules. Comme expliqué précédemment, les exercices et les projets de niveau 1 à 3 ont pour objectif de vous préparer aux exercices plus complexes. Vous réaliserez ces exercices dans chaque module de ce cours.

Les projets de niveau 4, les challenges et les interrogations sont les activités qui contribuent le plus à votre note finale. Vous trouverez ci-dessous les modules qui comprennent ces activités.

Pour le premier quadrimestre

![](images/sdd2_00/sdd2_q1_orga.drawio.png)

Pour le second quadrimestre

![](images/sdd2_00/sdd2_q2_orga.drawio.png)

Les informations données ci-dessus sont données à titre indicatif. Elles sont susceptibles d'évoluer au cours de l'année académique.
