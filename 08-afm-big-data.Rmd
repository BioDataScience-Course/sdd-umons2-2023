...
if (exists("assignment"))
  assignment("B08Ia_mfa", part = NULL,
    ...
    course.urls = c(
      'S-BIOG-061' = "https://classroom.github.com/a/eLXZvBYq"),
    course.starts = c(
...
La vitesse d'écriture (et de lecture) dépend naturellement de R, mais aussi de la vitesse du disque utilisé. La machine où ce cours est compilé est assez rapide. L'écriture prend moins d'une seconde. Dans SaturnCloud, c'est un peu plus lent, mais toujours très acceptable.
...
if (exists("assignment"))
  assignment("B08Ib_zooscannet", part = NULL,
    ...
    course.urls = c(
      'S-BIOG-061' = "https://classroom.github.com/a/vt_aMu3M"),
    course.starts = c(
      'S-BIOG-061' = !"{W[26]+1} 13:00:00"),
    course.ends = c(
      'S-BIOG-061' = !"{W[27]+1} 23:59:59"),
