...
**Le script R relatif à cette section est disponible [ici](https://raw.githubusercontent.com/BioDataScience-Course/sdd_lessons/2022-2023/B09/R/B09Ra_db_mds.R).** Il peut être copié et collé dans un document `.R` dans RStudio sous SaturnCloud pour l'exécuter et l'explorer par vous-même.
...
-   Site web du [package {dm}](https://krlmlr.github.io/dm/index.html) en anglais. Il y a queqlques documents techniques qui explisuent les différents aspects de ce package riche en fonctions.
...
-   Un autre [tutoriel complet sur SQL](http://blog.paumard.org/cours/sql/), en français cette fois-ci. Remarquez qu'il en existe beaucoup. Faites une recherche via Google et choisissez le tutoriel qui vous plaît le plus.
...
if (exists("assignment"))
  assignment("B09Ia_portalr", part = NULL,
    ...
    course.urls = c(
      'S-BIOG-061' = "https://classroom.github.com/a/XjUT5Glx"),
    course.starts = c(
